# ai-japanese-learning v1.5

当前版本已经推进到 `v1.5`，重点把挑战阅读入口改造为文章侧栏的 JLPT 重点词汇/语法推荐，并将阅读后测验调整为 JLPT 阅读理解侧栏题，同时让划词 AI 释义结合上下文返回完整表达和文法/单词分类。
...
- 阅读页右侧展示 3-5 个重点词汇、3-5 个重点语法和 3-5 道 JLPT 阅读理解题
...
- 阅读页右侧会按“重点词汇”和“重点语法”分组展示 AI 推荐，并保留加入生词本入口。
