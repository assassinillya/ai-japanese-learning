...
func NewRouter(
	...
	r.mux.HandleFunc("GET /api/articles/public", r.withAuth(r.handlePublicArticles))
	...
	r.mux.HandleFunc("POST /api/dictionary/examples/generate", r.withAuth(r.handleDictionaryExampleGenerate))
	r.mux.HandleFunc("DELETE /api/dictionary/examples/{id}", r.withAuth(r.handleDictionaryExampleDelete))
	r.mux.HandleFunc("GET /api/dictionary/{id}/examples", r.withAuth(r.handleDictionaryExamples))
